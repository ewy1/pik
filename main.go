...
import (
	_ "embed"
	"fmt"
	"git.ewy.one/pik.git/cache"
	"git.ewy.one/pik.git/crawl"
	"git.ewy.one/pik.git/flags"
	"git.ewy.one/pik.git/git"
	"git.ewy.one/pik.git/indexers/pikdex"
	"git.ewy.one/pik.git/menu"
	"git.ewy.one/pik.git/model"
	"git.ewy.one/pik.git/paths"
	"git.ewy.one/pik.git/run"
	"git.ewy.one/pik.git/runner/exc"
	"git.ewy.one/pik.git/runner/gnumake"
	"git.ewy.one/pik.git/runner/just"
	"git.ewy.one/pik.git/runner/python"
	"git.ewy.one/pik.git/runner/shell"
	"git.ewy.one/pik.git/search"
